...
public class CubeTween : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Tween move1 = transform.TMove(transform.position, transform.position + Vector3.up, duration1, EaseMode.Bell2);
        Tween rotation1 = transform.TRotate(transform.rotation,Quaternion.LookRotation(Vector3.down), duration1, EaseMode.SmoothStart3);
        Tween scale1 = transform.TScale(Vector3.one, Vector3.one * 1.5f, duration1, EaseMode.SmoothStop3);
        ...
        Tween scale2 = transform.TScale(Vector3.one * 1.5f, Vector3.one * .6f, duration2, EaseMode.Linear);
        ...
        Tween fade4 = GetComponent<Renderer>().material.TFade(1f, 0f, duration4, EaseMode.SmoothStop3);
